<?php include "incl/header.php"; ?>
    ...
    <!-- Page Testimonials Section Start -->
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="testimonial-item wow fadeInUp" data-wow-delay="0.2s">
                        <div class="testimonial-item-header">
                            ...
                            <div class="testimonial-item-content">
                                <p>"A beautifully organized event with flawless execution. Every detail—from registration to the closing ceremony—was handled professionally. I gained valuable insights and built meaningful connections."</p>
                            </div>
                        </div>
                        <div class="testimonial-item-footer">
                            <div class="testimonial-author">
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="testimonial-item wow fadeInUp" data-wow-delay="0.4s">
                        <div class="testimonial-item-header">
                            ...
                            <div class="testimonial-item-content">
                                <p>"The workshops were practical, hands-on, and extremely enriching. The mentors were knowledgeable and approachable. I walked away with skills I can immediately apply to my career."</p>
                            </div>
                        </div>
                        <div class="testimonial-item-footer">
                            <div class="testimonial-author">
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="testimonial-item wow fadeInUp" data-wow-delay="0.6s">
                        <div class="testimonial-item-header">
                            ...
                            <div class="testimonial-item-content">
                                <p>"I've attended many conferences, but this one truly stood out. The atmosphere was welcoming, the sessions were high-quality, and the networking opportunities were priceless."</p>
                            </div>
                        </div>
                        <div class="testimonial-item-footer">
                            <div class="testimonial-author">
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="testimonial-item wow fadeInUp" data-wow-delay="0.8s">
                        <div class="testimonial-item-header">
                            ...
                            <div class="testimonial-item-content">
                                <p>"This event provided exactly what I needed—motivation, clarity, and direction. The experts shared real, practical knowledge that helped me reshape my approach. Truly a life-changing experience."</p>
                            </div>
                        </div>
                        <div class="testimonial-item-footer">
                            <div class="testimonial-author">
                                <div class="testimonial-author-image">
                                    <figure class="image-anime">
                                        <img src="https://html.awaikenthemes.com/evenza/images/author-5.jpg" alt="">
                                    </figure>
                                </div>
                                <div class="testimonial-author-content">
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="testimonial-item wow fadeInUp" data-wow-delay="1s">
                        <div class="testimonial-item-header">
                            ...
                            <div class="testimonial-item-content">
                                <p>"I was impressed by the professionalism and warmth of the entire team. The sessions were structured perfectly, and the environment encouraged open discussion and idea-sharing. Highly recommended!"</p>
                            </div>
                        </div>
                        <div class="testimonial-item-footer">
                            <div class="testimonial-author">
                                <div class="testimonial-author-image">
                                    <figure class="image-anime">
                                        <img src="https://html.awaikenthemes.com/evenza/images/author-6.jpg" alt="">
                                    </figure>
                                </div>
                                <div class="testimonial-author-content">
                                    <h3>Robert Fox</h3>
