                    ...
                    <div class="post-item wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="post-item-body">
                            ...
                            <div class="post-item-body-content">
                                <div class="post-item-meta">
                                    <ul>
                                        <li><img src="images/icon-author.svg" alt="">Jane Cooper</li>
                                    </ul>                                    
                                </div>
                                <div class="post-item-content">
                    ...
                    <div class="post-item wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <div class="post-item-body">
                            ...
                            <div class="post-item-body-content">
                                <div class="post-item-meta">
                                    <ul>
                                        <li><img src="images/icon-author.svg" alt="">Cameron Williamson</li>
                                    </ul>                                    
                                </div>
                                <div class="post-item-content">
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="post-item wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <div class="post-featured-image">
                            <a href="blog-single.html"  data-cursor-text="View">
                                <figure class="image-anime">
                                    <img src="https://html.awaikenthemes.com/evenza/images/post-4.jpg" alt="">
                                </figure>    
                            </a>                            
                        </div>
                        <!-- Post Featured Image End -->
                        ...
                        <div class="post-item-body">
                            ...
                            <div class="post-item-body-content">
                                <div class="post-item-meta">
                                    <ul>
                                        <li><img src="images/icon-author.svg" alt="">Floyd Miles</li>
                                    </ul>                                    
                                </div>
                                <div class="post-item-content">
                                    <h2><a href="blog-single.html">Expert Tips for Planning High-Impact Corporate Conferences</a></h2>
                                </div>
                            </div>
                            <!-- Post Item Body Content End -->
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="post-item wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <div class="post-featured-image">
                            <a href="blog-single.html"  data-cursor-text="View">
                                <figure class="image-anime">
                                    <img src="https://html.awaikenthemes.com/evenza/images/post-5.jpg" alt="">
                                </figure>    
                            </a>                            
                        </div>
                        <!-- Post Featured Image End -->
                        ...
                        <div class="post-item-body">
                            ...
                            <div class="post-item-body-content">
                                <div class="post-item-meta">
                                    <ul>
                                        <li><img src="images/icon-author.svg" alt="">Jerome Bell</li>
                                    </ul>                                    
                                </div>
                                <div class="post-item-content">
                                    <h2><a href="blog-single.html">How Successful Conferences Build Strong Professional Networks</a></h2>
                                </div>
                            </div>
                            <!-- Post Item Body Content End -->
                ...
                <div class="col-xl-4 col-md-6">
                    ...
                    <div class="post-item wow fadeInUp" data-wow-delay="1s">
                        ...
                        <div class="post-featured-image">
                            <a href="blog-single.html"  data-cursor-text="View">
                                <figure class="image-anime">
                                    <img src="https://html.awaikenthemes.com/evenza/images/post-6.jpg" alt="">
                                </figure>    
                            </a>                            
                        </div>
                        <!-- Post Featured Image End -->
                        ...
                        <div class="post-item-body">
                            ...
                            <div class="post-item-body-content">
                                <div class="post-item-meta">
                                    <ul>
                                        <li><img src="images/icon-author.svg" alt="">Devon Lane</li>
                                    </ul>                                    
                                </div>
                                <div class="post-item-content">
                                    <h2><a href="blog-single.html">Behind the Scenes of World-Class Conference Production</a></h2>
                                </div>
                            </div>
                            <!-- Post Item Body Content End -->
