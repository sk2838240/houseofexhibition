(function ($) {
	...
	/* Feature Slider JS */
	if ($('.feature-slider-metal').length) {
		const feature_slider_metal = new Swiper('.feature-slider-metal .swiper', {
			slidesPerView : 1,
			speed: 1000,
			spaceBetween: 30,
			loop: true,
	...
	if ($('.testimonial-slider-metal').length) {
		const testimonial_slider = new Swiper('.testimonial-slider-metal .swiper', {
			slidesPerView : 1,
			speed: 1000,
			spaceBetween: 30,
			loop: true,
