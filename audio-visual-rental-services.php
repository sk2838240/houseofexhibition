        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="page-header-box">
                    <h1 class="text-anime-style-3" data-cursor="-opaque">Audio Visual Rental Services in Dubai</h1>
                    <nav class="wow fadeInUp">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">home</a></li>
                            <i class="fa-solid fa-angles-right" style="color: #fff !important;padding: 3px 25px 0px 20px;"></i>
                            <li class="breadcrumb-item active" aria-current="page">Audio Visual Rental Services in Dubai</li>
                        </ol>
                    </nav>
                </div>
                <!-- Page Header Box End -->
